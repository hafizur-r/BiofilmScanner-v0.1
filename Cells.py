"""
Mask R-CNN
Train on the toy Cells dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 Cells.py train --dataset=/path/to/datasets --weights=coco
  

    # Resume training a model that you had trained earlier
    python3 Cells.py train --dataset=/path/to/datasets --weights=last

    # Train a new model starting from ImageNet weights
    python3 Cells.py train --dataset=/path/to/datasets --weights=imagenet

    # Apply color splash to an image
    python3 Cells.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 Cells.py splash --weights=last --video=<URL or path to file>
"""
